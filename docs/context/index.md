...
| Config | [`config.md`](config.md) | `internal/config` | Defines, validates, migrates, watches, initializes, loads, and saves user configuration. |
...
| Presence | [`presence.md`](presence.md) | `internal/presence` | Maps detections to Discord activity and owns validated, cancellation-aware IPC. |
| Registry | [`registry.md`](registry.md) | `internal/registry` | Defines built-in/custom tools, resolves logos, and matches process identity to tools. |
