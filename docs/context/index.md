...
| Presence | [`presence.md`](presence.md) | `internal/presence` | Maps detections to defensively bounded activity, logs optional-field omissions, and classifies payload versus transport IPC failures. |
